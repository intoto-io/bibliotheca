...
function bridgeLine(
  ...
  const points: [number, number][] = [
    [xScaleProfile(firstPoint.x), yScaleProfile(firstPoint.y)],
    [xScaleProfile(firstPoint.x + tw), yScaleProfile(firstPoint.y + bridgeHeight)],
    [xScaleProfile(lastPoint.x - tw), yScaleProfile(lastPoint.y + bridgeHeight)],
    [xScaleProfile(lastPoint.x), yScaleProfile(lastPoint.y)],
  ];

  const supports: [number, number][] = [[xScaleProfile(firstPoint.x + tw), yScaleProfile(bridgeLevel + bridgeHeight)]];
